...
public class DetectDigit {
    ...
    public void init() {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                ...
                procCell.convertTo(procCell, CvType.CV_32FC1);
    ...
    private static Mat center(Mat digit) {
    ...
    //change image in the right format?
    //https://java.wekeepcoding.com/article/11705334/openCV+KNN+findNearest+Error
    ...
    public Integer detect(Mat digit) {
        ...
        /*System.out.println(wraped.toString());
        System.out.println(procSimple(wraped).toString());
        System.out.println(result.toString());*/

        
        //Something wrong with the findNearest() method
